...
[8u73](http://www.oracle.com/technetwork/java/javase/downloads/jdk8-downloads-2133151.html).
...
version to a release e.g. '~> 8.0' or an update e.g. '~> 8.73.0' in your metadata.rb cookbook or 
...
`cookbook 'java_se', '~> 8.73.0'`

Constrains install to Java SE JDK 8u73.
...
will match https://s3.amazonaws.com/mybucket/java/jdk-8u73-windows-i586.exe. Note that JDK file names must be the
...
2. UPDATE is the Java update e.g. 73
