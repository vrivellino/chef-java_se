if node['java_se']['skip']
  ...
  node.default['java_se']['arch'] = arch

  node.default['java_se']['version'] = "1.#{node['java_se']['release']}.0_#{node['java_se']['update']}"
  node.default['java_se']['jdk_version'] = "#{node['java_se']['release']}u#{node['java_se']['update']}"
